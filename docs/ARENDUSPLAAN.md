...
- **Põhietapp tehtud:** inventari koondharu nähtavast „Tekst kaardile” nupust või paremklõpsust saab luua kaardi nähtava ala keskele staatilise tekstiobjekti, mis sisaldab haru pealkirja, kogusummat ja allikaridu. Objekti paremklõpsust saab luua eraldi teksti kas märkmetest või selle objekti inventarist. Mõlemad pärivad objekti grupi ning loomisel saab valida püsiva nime ja sisu sünkroonimise ning objekti juurde viitava joone. Inventaritekst uueneb objekti nime või inventariridade muutmisel. Seos, allikatüüp, sünkroonimine ja joone valik säilivad `.pplan` versioon 18 failis ning neid saab tekstiobjekti vaates sisse või välja lülitada. Hilisemaks jääb eraldi tegevus, mis katkestab allikaseose täielikult ja muudab teksti tavaliseks staatiliseks tekstiks.
