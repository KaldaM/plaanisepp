...
- **Tehtud (esimene etapp):** plaanile saab „Plaani andmed” dialoogis määrata vabatahtliku festivali või sündmuse, mille osa see on. Seos salvestatakse plaanifaili ja kuvatakse raporti plaaniandmetes. Festivalide kaupa plaanide sirvimine lisatakse koos tulevase plaanide ühise hoiustamisega.
...
- **Plaanitud:** kui tulevikus saab vaadata kõiki ühe festivali alaplaane koos, peab nende kohta saama koostada ühise kokkuvõtte. See peab vähemalt loetlema kõik festivali plaanides kasutatud linna elektrikilbid, et tehnikajuht saaks elektrikult võtmeid ja vajalikud load korraga küsida.
