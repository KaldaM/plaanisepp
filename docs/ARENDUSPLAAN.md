...
- **Põhietapp tehtud:** inventari koondharu nähtavast „Tekst kaardile” nupust või paremklõpsust saab luua kaardi nähtava ala keskele staatilise tekstiobjekti, mis sisaldab haru pealkirja, kogusummat ja allikaridu. Objekti või inventarirea märkmetest loodav tekst pärib objekti grupi ning loomisel saab valida püsiva nime ja märkmete sünkroonimise ning objekti juurde viitava joone. Seos, sünkroonimine ja joone valik säilivad `.pplan` versioon 17 failis ning neid saab tekstiobjekti vaates sisse või välja lülitada. Hilisemaks jääb eraldi tegevus, mis katkestab allikaseose täielikult ja muudab teksti tavaliseks staatiliseks tekstiks.
